...
using Divergence_App.Contracts.ViewModels;

using Microsoft.Web.WebView2.Core;

namespace Divergence_App.ViewModels;
...
public partial class ContentViewModel : ObservableRecipient, INavigationAware
{
    // TODO: Set the default URL to display.
    [ObservableProperty]
    private Uri source = new("https://divergencesmp.site");
    ...
    public ContentViewModel(IWebViewService webViewService)
    {
